...
class L2C(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        # Gateway へのarp
        match = parser.OFPMatch(eth_dst='ff:ff:ff:ff:ff:ff', eth_type=0x0806, arp_spa=self.gateway_ip)
        ...
        match = parser.OFPMatch(eth_dst=self.gateway_mac, eth_type=0x0806, arp_spa=self.gateway_ip)
